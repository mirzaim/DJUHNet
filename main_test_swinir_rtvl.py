...
def main():
    ...
    parser.add_argument('--scale', type=int, default=8, help='scale factor: 1, 2, 3, 4, 8') # 1 for dn and jpeg car
    ...
    parser.add_argument('--model_path', type=str,
                        default='superresolution/swinir_sr_classical_with_img_rtvl_patch48_x8/models/42000_E.pth')
    parser.add_argument('--folder_lq', type=str, default='testsets/urban100x8/bicx8', help='input low-quality test image folder')
    parser.add_argument('--folder_gt', type=str, default='testsets/urban100x8/modx8', help='input ground-truth test image folder')
